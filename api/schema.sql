...
-- Admins table (secure login + roles)
CREATE TABLE IF NOT EXISTS admins (
    ...
    permissions TEXT NULL COMMENT 'JSON permission flags',
...
INSERT INTO admins (username, password_hash, is_super_admin, is_active) VALUES
('admin', '$2y$12$BgNmMBG01qSzyBdEYJux3eR2HfJQ5aAZOvbQK3MGl3DrqRQECSaua', 1, 1)
