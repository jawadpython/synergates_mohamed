<?php
require_once __DIR__ . '/admin/require_auth.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="admin-nav">
        <div class="admin-nav-inner">
            ...
            <div class="admin-nav-links">
                <a href="admin/blogs.php" class="admin-nav-link"><i class="fas fa-arrow-left mr-1"></i> Back to Blogs</a>
                <a href="admin/dashboard.php" class="admin-nav-link">Dashboard</a>
                <a href="admin/faqs.php" class="admin-nav-link">FAQ</a>
                <a href="admin/logout.php" class="admin-nav-link exit">Logout</a>
            </div>
        </div>
    </nav>
    ...
    <div class="admin-page" style="max-width:48rem">
        ...
        <form id="blog-form" class="space-y-6">
            ...
            <div class="flex justify-between items-center">
                <a href="admin/blogs.php" class="admin-btn admin-btn-secondary">Cancel</a>
    ...
    <script>
        ...
        async function insertContentImage(input, editorId) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    img.src = data.url.startsWith('http') ? data.url : data.url.replace(/^\//, '');
                    img.alt = 'Blog image';
        ...
        async function saveBlog(status) {
            ...
            try {
                ...
                const data = await response.json();
                if (data.success) {
                    window.location.href = 'admin/blogs.php';
                } else {
